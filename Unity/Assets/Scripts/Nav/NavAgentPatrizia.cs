...
public class NavAgentPatrizia : MonoBehaviour
{
    private NavAgent<NavAgentPatrizia> _navAgent;
    private Animator _animator;

    void Awake()
    {
        _navAgent = new NavAgent<NavAgentPatrizia>(gameObject, new FiniteStateMachine<NavAgentPatrizia>(gameObject));
